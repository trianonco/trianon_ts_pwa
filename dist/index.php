...
$GENDER_VALUE = $REQUEST_URI_PARAMETERS[$REQUEST_URI_PARAMETER_GENDER_KEY];
$CATEGORY_VALUE = $REQUEST_URI_PARAMETERS[$REQUEST_URI_PARAMETER_CATEGORY_KEY];
$DESCRIPTION_VALUE = $REQUEST_URI_PARAMETERS[$DESCRIPTION_KEY];
