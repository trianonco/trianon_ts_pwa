                        ...
                        <td align="center" valign="top">
                            <table>
                                <tr>
                                    <td align="center" valign="top">
                                        <br>
                                        <img style="display: block; margin: 0 auto; padding: 5px;border:1px solid #d7ab34;"
                                            width="100px" src="${TEMPLATE.ORDER_PRODUCT_PICTURE}">
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" valign="top">
                                        <h1
                                            ...
                                            ¡Gracias
                                            por tu preferencia en nosotros!</h1>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" valign="top">
                                        <h2 style="color: #4e4b43;font-size: 13px; letter-spacing: 1px;">Pronto tendras
                                            lo mejor de la
                                            marroquinería en tus manos</h2>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    ...
                                    <td align="center" valign="top" width="300px">
                                        ...
                                        <h2
                                            ...
                                            El código de rastreo estará disponible dentro de las próximas 48 horas.
                                        </h2>
                                        <br>
                                        <h2
