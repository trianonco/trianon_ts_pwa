...
$GENDER_VALUE = urldecode($REQUEST_URI_PARAMETERS[$REQUEST_URI_PARAMETER_GENDER_KEY]);
$CATEGORY_VALUE = urldecode($REQUEST_URI_PARAMETERS[$REQUEST_URI_PARAMETER_CATEGORY_KEY]);
...
$vue_pwa_html_template = file_get_contents('index2.html');
